export default function handler(req, res) {
  const { title, desc, img } = req.query;
  ...
  const html = `
    ...
    <head>
      ...
      <!-- Redirect ke katalog -->
      <meta http-equiv="refresh" content="0; url=https://florist-test.vercel.app/catalog">
      <style>
    ...
    <body>
      ...
      <p>Jika tidak dialihkan otomatis, <a href="https://florist-test.vercel.app/catalog">klik di sini</a>.</p>
    </body>
    </html>
  `;
